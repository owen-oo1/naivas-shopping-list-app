    ...
    <div className="min-h-screen bg-background flex">
      <div className="hidden lg:flex w-1/2 bg-primary items-center justify-center">
        <div className="text-center text-primary-foreground max-w-md px-8">
          ...
          <h2 className="font-display text-3xl font-bold mb-4">Join Naivas</h2>
          <p className="text-primary-foreground/80 font-body">
            Create your account and start building smarter shopping lists today.
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-md">
          <Link to="/" className="flex items-center gap-2 mb-8">
            ...
            <span className="font-display font-bold text-lg">Naivas</span>
          </Link>
          ...
          <a
            ...
            className="flex items-center justify-center gap-2 w-full h-10 rounded-lg border bg-card text-sm font-medium text-foreground hover:bg-muted transition-colors"
          >
